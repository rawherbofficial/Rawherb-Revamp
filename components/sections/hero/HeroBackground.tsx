...
export default function HeroBackground({ letterOffsetX, letterOffsetY }: Props) {
  return (
    <>
      {/* Giant R letterform */}
      <div style={{
        ...
        color: 'transparent',
        WebkitTextStroke: '1px rgba(74,124,89,0.12)',
        zIndex: 0,
      ...
      <div style={{
        position: 'absolute', top: '50%', left: '50%',
        marginTop: '-60px', marginLeft: '-210px',
        ...
        <div style={{
          ...
          borderRadius: '50%', background: 'var(--green-l)',
